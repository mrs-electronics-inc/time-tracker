...
- [x] Ensure selection is non-actionable when filtered result count is zero
...
- [x] Show search-specific empty message when filter has zero matches (distinct from no-data message)
- [x] Ensure viewport and row rendering use filtered rows consistently
